...
public:
  ...
  GString* getCSStyle (int i, GString* content,int j);
  GString* getCSStyle (int i, GString* content,int j,bool isMultiColumn,int marginTop,int pageWidth);
  GString* getMultiColumnCSStyle(int i, GString* content,int j,int coumnIndex,int marginTop,int lineheight);
  GString* getMultiColumnCSStyle(int i, GString* content,int j,int coumnIndex,int marginTop,bool b,int lineheigtht,int paddingLeft);
  GString* getColumnCSStyle(int i, GString* content,int j,int paddingLeft,int columnIndex,int marginTop,int lineheight);  
  GString* getIntersectColumnCSStyle(int i, GString* content,int j,int coumnIndex,int marginTop,int paddingLeft);
